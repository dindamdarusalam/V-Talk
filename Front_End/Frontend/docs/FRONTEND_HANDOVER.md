...
- WebSocket menambahkan token login sebagai query param saat user sudah autentikasi, sehingga log backend tetap terkait user.
- Riwayat translasi server diload dari `GET /api/v1/translations/history` hanya saat user login, supaya guest tidak membaca log global.
