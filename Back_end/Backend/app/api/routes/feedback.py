...
def submit_feedback(
    ...
    if translation.user_id is not None and translation.user_id != (current_user.id if current_user else None):
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
            detail="Cannot submit feedback for another user's translation",
        )
